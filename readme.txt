...
Widget that displays the current post author's Gravatar photo, name, website, and biography. 

== Description ==

I created this plugin to address a problem brought up in this forum thread:
`http://wordpress.org/support/topic/dynamic-image-in-sidebar`
...
1. In your Dashboard, hover over the Plugins menu, and select 'Add New'
2. Select the 'Upload' option, and upload `odai-author-widget.zip`
3. Activate the plugin through the 'Plugins' menu in WordPress
4. Visit a post on your site and see how it looks!

== Screenshots ==

1. A screen capture of the widget running on my personal website, http://odai.me, and displaying my author information.
